...
{    
    ...
    0x1043,                 // Vendor ID (stealing from iCreate Technologies)
    0x0015,                 // Product ID: ?E was the latest
...
CFG01={
    ...
    /* Endpoint Descriptor */
	//polling rate at 5 ms
    sizeof(USB_EP_DSC),DSC_EP,_EP01_IN,_INT,HID_INT_IN_EP_SIZE,0x02 // poll at 500Hz
};
...
'A','n','a','l','o','g',' ','R','e','a','d','e','r'};

/*
#define DEVICE_SENDDATA_SIZE		18
...
rom struct{byte report[HID_RPT01_SIZE];}hid_rpt01={
    ...
    0x09, 0x40, /*      Usage (Hat Switch)                *///for some reason this is needed to send all 8 vals above it through
...
//    0x09, 0x37, /*      Usage (Dial)                */		
//    0x09, 0x40, /*      Usage (Hat Switch)                *///not working
//    0x09, 0x41, /*      Usage (Hat Switch)                *///not working
//    0x09, 0x42, /*      Usage (Hat Switch)                */
//    0x09, 0x39, /*      Usage (Hat Switch)                */
//    0x09, 0x39, /*      Usage (Hat Switch)                */
...
//    0x26, 0xFF, 0x03, /*      Logical Maximum (1023)                 */
    0x75, 0x10, /*      Report Size (16)                */ 		//16 bit values sent
    0x95, 0x0D, /*      Report Count (13)                    */	//how many 16 bit reports sent
//    0x95, 0x09, /*      Report Count (9)                    */	//how many 16 bit reports sent
